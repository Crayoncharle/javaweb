...
public class UserController {
    ...
    public HttpResponseEntity userLogin(@RequestBody UserEntity userEntity) {
        ...
        try {
//            System.out.println(userEntity.getPassword() + "  " + userEntity.getUsername());
            List<UserEntity> hasUser = userEntityMapper.selectUserInfo(userEntity);
//            for(UserEntity user:hasUser){
...
//            }
            ...
            } else if (hasUser.get(0).getPassword().equals(userEntity.getPassword())) {
